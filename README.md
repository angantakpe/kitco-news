...
```bash
git remote set-url origin git@github.com:kitconews/kitconews.git
```

- Add this repo as another "remote" to allow you to get updates later:

```bash
git remote add upstream git@github.com:kitconews/kitconews.git
```
...
origin    git@github.com:kitconews/kitconews.git (fetch)
origin    git@github.com:kitconews/kitconews.git (push)
upstream    git@github.com:kitconews/kitconews.git (fetch)
upstream    git@github.com:kitconews/kitconews.git (push)
```
